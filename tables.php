            ...
            <ul class="nav navbar-top-links navbar-right">
                <!-- main dropdown -->
                 ...
                 <li class="dropdown">
                    ...
                    <li>
                            <?php
                            echo '<a href="tables.php?type='.$var.'&hall=hall&status='.$stat.'">';
                            ?>
                                <div>
                                    <i class=""></i>All Halls
                    ...
                    <?php
                                    ...
                                    while($loginh=mysql_fetch_assoc($records1)) {
                                            ...
                                            echo "<li>";
                                            echo "<a href= tables.php?type=$var&hall='";
                                            echo ''.$loginh['code'].'';
                                            echo "'&status=$stat>";
                                            echo "<div>";
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
                            <?php
                            echo '<a href="tables.php?type='.$var.'&hall='.$hal.'&status=Priority">'
                            ?>
                                <div>
                                    <i class=""></i>Priority
                        ...
                        <li>
                            <?php
                            echo '<a href="tables.php?type='.$var.'&hall='.$hal.'&status=Pending">'
                            ?>
                                <div>
                                    <i class=""></i>Pending
                        ...
                        <li>
                            <?php
                            echo '<a href="tables.php?type='.$var.'&hall='.$hal.'&status=Processing">'
                            ?>
                                <div>
                        ...
                        <li>
                            <?php
                            echo '<a href="tables.php?type='.$var.'&hall='.$hal.'&status=Completed">'
                            ?>
                                <div>
                                    <i class=""></i>Completed
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <?php
                        echo '<a href="tables.php?type=complaint_type&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>All Complaints</a>'
                        ?>
                    </li>
                    <li>
                        <?php
                        echo '<a href="tables.php?type=\'Water\'&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>Water</a>'
                        ?>
                    </li>
                    <li>
                        <?php
                        echo '<a href="tables.php?type=\'Electrical\'&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>Electrical</a>'
                        ?>
                    </li>
                    <li>
                        <?php
                        echo '<a href="tables.php?type=\'Civil\'&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>Civil</a>'
                        ?>
                    </li>
                    <li>
                        <?php
                        echo '<a href="tables.php?type=\'Sanitory\'&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>Sanitory</a>'
                        ?>
                    </li>
                    <li>
                        <?php
                        echo '<a href="tables.php?type=\'Accomodation\'&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>Accomodation</a>'
                        ?>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <?php
                        echo '<a href="tables.php?type=\'Mess (food)\'&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>Food</a>'
                        ?>                                
                            </li>
                            <li>
                                <?php
                        echo '<a href="tables.php?type=\'Mess (service)\'&hall='.$hal.'&status='.$stat.'"><i class="fa fa-dashboard fa-fw"></i>Service</a>'
                        ?>
                            </li>
                        </ul>
                        <!-- second-level-items -->
